...
function Store() {
  ...
  return (
    ...
    <h1 style={{marginTop:'30px' ,marginBottom:'10px' }}>Welcome to our food and grocery store</h1>
    <h1 style={{marginTop:'10px' ,marginBottom:'50px' ,marginLeft:'25%'}}>- where <strong>Freshness</strong> you can taste,<strong>quality</strong> you can trust</h1>
    ...
    { 
       ...
       (
        ...
        <Productcard hh={idx} products={element}/>
